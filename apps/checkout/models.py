...
class Order(models.Model):
    ...
    billing_info = models.ForeignKey(BillingInformation, on_delete=models.CASCADE, related_name='order', null=True, blank=True)
    shipping_info = models.OneToOneField(ShippingInformation, on_delete=models.CASCADE, related_name='order', null=True, blank=True)
    payment_info = models.OneToOneField(PaymentInformation, on_delete=models.CASCADE, related_name='order', null=True, blank=True)
